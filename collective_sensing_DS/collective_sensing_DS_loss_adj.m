...
function [best_estimate, best_error, rmserror, y] = collective_sensing_DS_loss_adj(k,adj,varargin)
...
%     end
    ...
    inputs = (k./sum(adj)).*sum(adj.*repmat(y(t-1,:),N,1)');
    y(t,:) = (1-k)*y(t-1,:) + inputs*h + k*w;  % do I want to change up the way noise is incorporated
end
